...
class DataTransform:
    ...
    def __call__(self, kspace, target, attrs, fname, slice):
        ...
        image = image # No crop required as original dimensions are cropped dimensions
        # Absolute value
...
if __name__ == '__main__':
    ...
    # Added by Sayantan Bhadra
    parser.add_argument('--master_port', type=int, default=1234, help='Master Port, set as $RANDOM')
