...
parser.add_argument("--T_in", type=int, default=20000, help="Total number of iterations")
...
parser.add_argument("--results_path", type=str, default='', help="results_path")
...
with tf.Session() as sess:
    ...
    np.save(args.results_path + '.npy', Gzest)
    Gzest = np.clip(Gzest*255, 0, 255).astype(np.uint8)
    io.imsave(args.results_path + '.png', Gzest)
